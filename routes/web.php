...
Route::get('/admin/tracking', [PortalController::class, 'adminTracking'])->name('admin.tracking');
...
Route::get('/delivery-manager/dashboard', [PortalController::class, 'deliveryManagerDashboard'])->name('delivery-manager.dashboard');
Route::get('/delivery-person/dashboard', [PortalController::class, 'deliveryPersonDashboard'])->name('delivery-person.dashboard');
Route::get('/pharmacy/dashboard', [PortalController::class, 'pharmacyDashboard'])->name('pharmacy.dashboard');
